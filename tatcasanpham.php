...
<a onclick="<?php if($dong_chitiet['soluong'] == 0){ ?> alert('Sản phẩm <?php echo $dong_chitiet['ten_sp']  ?> hết hàng ')      <?php } else { ?> alert('Sản phẩm <?php echo $dong_chitiet['ten_sp']  ?> được thêm vào giỏ hàng ') <?php } ?>" title="" href="index.php?module=giohang&tu=tatcasanpham&add=<?php echo $dong_chitiet['masp'] ?>&soluong=<?php echo $dong_chitiet['soluong'] ?>" class="order_item">+ Giỏ hàng</a>
