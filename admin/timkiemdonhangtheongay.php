<?php
  ...
  if(isset($_POST['submit']) && isset($_POST['dau'])){
  $ketqua = $_POST['dau'];
   }
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <?php
            if(isset($ketqua)){
                $sql_chitiet1 = "select * from oder WHERE (datesau = '$ketqua' ) AND (status = 'Đang xử lý')  ORDER BY order_id DESC ";
            ...
            <div class="box-body">
              <table id="" class="table table-bordered table-hover">
                ...
                <?php
                if(isset($ketqua)){
                $sql_chitiet = "select * from oder WHERE (datesau = '$ketqua' ) AND (status = 'Đang xử lý')  ORDER BY order_id DESC ";
              ...
              Trang:
               <?php
               if(isset($ketqua)){ 
$sql_trang = mysqli_query($conn,"select * from oder WHERE (datesau = '$ketqua' ) AND (status = 'Đang xử lý')  ORDER BY order_id DESC ");
